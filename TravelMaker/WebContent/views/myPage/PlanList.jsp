  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    calendar = new FullCalendar.Calendar(calendarEl, {
      ...
      , eventRender:function(info) {   
    	  ...
    	  info.el.lastChild.innerHTML = info.el.lastChild.innerHTML + "<button type='button' class='deleteBtn' style='position:absolute; left:94%; margin-top:-2px; margin-bottom:5px;' onclick='deletePlan();'>삭제</button>"
