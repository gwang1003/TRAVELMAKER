	...
	<section id="body">
		...
		<section id="outer">
			<div class="outer">
				...
				<hr><hr style="width:650px; margin-left:0px;">
				<form id="updateForm" name="updateForm" style="margin-left:-100px;">
					<table style="margin-top:60px;">
						...
						<tr style="position:absolute">
							<td>
								<div style="margin-left:450px; margin-top:-12px; float:left;"><input type="text" id="key" style="width:100px;" placeholder="인증번호입력"></div>
								<div style="margin-top:-27px; margin-left:560px; float:left;"><button id="emailCheck" type="button">이메일 인증</button></div>
							</td>
						</tr>
					</table>
					<br><br>
