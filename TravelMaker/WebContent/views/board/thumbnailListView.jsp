        ...
        <div id="choice1">
            ...
            <div class="count">
                ...
                <div id="good">
                    ...
                    <a href="javascript:" class="btn_represch"><img src="../../resources/DetailImage/새로고침.png" id="represch" width="30px" height="30px"></a>&emsp;
                </div>
            ...
            <div id="festivalTable">
                <table border="1px solid black">
                    <tr>
                        <th width="300">대표사진</th>
                        <th width="550">제목/내용</th>
                        <th width="150" colspan="2">조회수</th>
                    </tr>
                    <tr>
                            <td><img src="서울2.jpg" alt=""></td>
                            <td>
                                <h3>경복궁</h3><br>유명한 인사동!! 쌈짓깃을 한번 가보자아아아앙~~
                            </td>
                            <td>
                                <h1>♥ 0</h1>
                            </td>
