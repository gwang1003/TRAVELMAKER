<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	Member mId = (Member)session.getAttribute("mId");
...
<body>
 ...
 <h1 style="color:black; font-weight:900; color:black; margin-top: 140px; margin-left: 40%;">지역별 숙박</h1>
    ...
    <br><br>
        ...
        <div id="main-wrap">
            <div class="travel">
                ...
                <div herf="#" style="float:right;font-size:20px; color:gray;cursor:pointer">추천수</div>
                <div href="#" style="float:right; font-size:20px; color:gray;cursor:pointer">가격순&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
  
                <br><br>
    
                <div class="wrap">
                    <a class="in-wrap" href="SleepDatila.jsp">
                        <div class="thumb-pic">
                            <img src='<%= request.getContextPath()%>/resources/images/호텔2.jpg'>
                        </div>
                        <div class="stage">
                            <h2>경복궁의 경치</h2>
                ...
                <div class="wrap">
                    <a class="in-wrap" href="#">
                        ...
                        <div class="stage gra_black_vertical">
                                          <div class="name">
                                    <div class="badge"><span class="build_badge" style="color: rgba(255,255,255,1); background-color: rgba(97,95,184,1);">5성급</span></div>     
                                    <strong>신라 서울</strong>
                                ...
                                <div class="price">
                                    <div class="map_html">
                                        <p><em class="mark"><span><b>남은 객실 2개</b><i>&nbsp;</i></span></em><b>459,800원~</b></p></div>
                                    </div>
                            </div>
                    </a>
                ...
                <div class="wrap">
                    <a class="in-wrap" href="#">
                        <div class="thumb-pic">
                            <img src='<%= request.getContextPath()%>/resources/images/호텔4.jpg'>
                        </div>
                        <div class="stage">
                            <h2>경복궁의 경치</h2>
                            <p>명물로도 유명한 경복의 경치는 무척이나 아름답다.</p>
    ...
    <div id="choice">
        <h2>지역</h2>
        <select style="width:100%; height:30px; font-size: 20px; align:center;">
            <option>--------</option>
            <option>서울</option>
                <option>경기</option>
                <option>강원</option>
                ...
                <br><br>
            <h2>Check In</h2>
            <input type="date" style="width:100%; text-align: center; font-size: 18px;">
            <br><br>
            <h2>Check Out</h2>
            <input type="date" style="width:100%; text-align: center; font-size: 18px;">
            ...
            <input type="checkbox" value="예약가능" style="width:20px; height:20px;">예약가능
            ...
            <div class="number">
                    <a href="#" id="decreaseQuantity">
                        <img id="minus" src='<%= request.getContextPath()%>/resources/images/마이너스.png'></a>&nbsp;&nbsp;
                   
                        <span id="numberUpDown">1</span>&nbsp;&nbsp;
                        
                            <a href="#" id="increaseQuantity">
                                <img id="minus" src='<%= request.getContextPath()%>/resources/images/플러스.png'></a>
    ...
    <br><br>
            ...
            <div class="number">
                    <a href="#" id="decreaseQuantity1">
                        <img id="minus" src='<%= request.getContextPath()%>/resources/images/마이너스.png'></a>&nbsp;&nbsp;
                   
                        <span id="numberUpDown">0</span>&nbsp;&nbsp;~
                        <span id="numberUpDown1">70000</span>&nbsp;&nbsp;
                        
                            <a href="#" id="increaseQuantity1">
                                <img id="minus" src='<%= request.getContextPath()%>/resources/images/플러스.png'></a>
    	...
    	<button id="noticeInsert" type="button" onclick="location.herf='<%= contextPath %>/views/Sleep/SleepInsert.jsp'">작성하기</button>
    	<%} %>
